...
#ifndef __MESSAGE_ADAPTOR_LOG_H__
#define __MESSAGE_ADAPTOR_LOG_H__
...
#define LOG_TAG "MESSAGE_ADAPTOR"
...
#define FONT_COLOR_BOLDWHITE  "\033[1m\033[37m"      /* Bold White */
	 ...
	 *  Gets thread ID
	 */
#define message_adaptor_gettid() syscall(__NR_gettid)
...
#define plugin_req_exit(ret, plugin, error)	do { \
		message_adaptor_info("[EXIT] plugin API called (%d) ((- ((- ((- ((- ((- ((- ((- ((- ((- ((-", (int)(ret)); \
		if ((error)) { \
			if ((*error)) { \
				message_adaptor_error("plugin issued error (%s) (%s)", (char *)((*error)->code), (char *)((*error)->msg)); \
...
#define plugin_req_exit_void()			do { \
		message_adaptor_info("[EXIT] plugin API called ((- ((- ((- ((- ((- ((- ((- ((- ((- ((-"); \
	} while (0)

#define plugin_req_id_print()			do { \
		message_adaptor_info("[REQUEST_ID] Important Request ID <%lld>", (long long int)request_id); \
	} while (0)
...
#endif /* __MESSAGE_ADAPTOR_LOG_H__ */
