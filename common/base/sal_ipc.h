...
#define SERVICE_PROVIDER_OBJ_PATH_PREFIX		"serviceprovider/"
...
/* req param len */
#define SERVICE_PROVIDER_BASE_SESSION_START_REQ_LEN 2
/* req params */
...
#define SERVICE_PROVIDER_BASE_SESSION_START_REQ	\
	...
	")"
/* res param len */
#define SERVICE_PROVIDER_BASE_SESSION_START_RES_LEN 3
/* res params */
#define SERVICE_PROVIDER_BASE_SESSION_START_RES	\
	"(" \
	"i" /* result */\
...
**/
#define SERVICE_PROVIDER_STORAGE_OPEN			"open"
/* req param len */
#define SERVICE_PROVIDER_STORAGE_OPEN_REQ_LEN	6
/* req params */
#define SERVICE_PROVIDER_STPRAGE_OPEN_REQ \
	"("\
	"s" /* session info */\
	"i" /* fd */\
	"s" /* path */\
	...
	")"
/* res param len */
#define SERVICE_PROVIDER_STORAGE_OPEN_RES_LEN 3
/* res params */
#define SERVICE_PROVIDER_STORAGE_OPEN_RES \
	"(" \
	"i" /* result */\
	"i" /* error code */\
	"s" /* error message */\
...
/* req param len */
#define SERVICE_PROVIDER_STORAGE_CLOSE_REQ_LEN	3
/* req params */
