...
#define SERVICE_FILE_ROOT_PATH          tzplatform_mkpath(TZ_SYS_SHARE, "/service-adaptor/")
#define SERVICE_FILE_SERVICES_PATH	tzplatform_mkpath(TZ_SYS_SHARE, "/service-adaptor/services/")
#define SERVICE_FILE_AUTH_PATH		tzplatform_mkpath(TZ_SYS_SHARE, "/service-adaptor/.auth/")
